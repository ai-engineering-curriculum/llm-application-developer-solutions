# AI Engineering · LLM Application Developer — Solutions Repository
...
Reference implementations for the paired [`llm-application-developer-learning`](https://github.com/ai-engineering-curriculum/llm-application-developer-learning) track.
...
```
llm-application-developer-solutions/
